...
class Message0410 {
	...
	public function setField038($value)	{ $this->field_038 = $value; }
	...
	public function getField038($value)	{ return $this->field_038; }
	...
	public function getMessage()
	{
		...
		if($ret)
		{
			...
			$ret &= strlen($this->field_038) ? $this->isoMsg->addField( 38, $this->field_038) : false;
	...
	public function decodeMessage($message)
	{
		...
		$this->field_038 = $this->isoMsg->getField( 38);
