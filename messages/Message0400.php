...
class Message0400 {
	...
	public function setField090($value)	{ $this->field_090 = $value; }
	public function setField125($value)	{ $this->field_125 = $value; }
	...
	public function getField090($value)	{ return $this->field_090; }
	public function getField125($value)	{ return $this->field_125; }
	...
	public function getMessage()
	{
		...
		if($ret)
		{
			...
			$ret &= strlen($this->field_125) ? $this->isoMsg->addField(125, $this->field_125) : false;
		}
	...
	public function decodeMessage($message)
	{
		...
		$this->field_125 = $this->isoMsg->getField(125);
	}
}
