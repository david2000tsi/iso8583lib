...
use ISO8583LIB\Messages\Message0420;
...
class Message0420Test extends PHPUnit_Framework_TestCase{
	...
	public function testMsg()
	{
		...
		$this->assertTrue($this->iso0420Instance->setField002("1008950013090478"));
		$this->assertTrue($this->iso0420Instance->setField003("003000"));
		$this->assertTrue($this->iso0420Instance->setField004("000000000010"));
		$this->assertTrue($this->iso0420Instance->setField007("1107123000"));
		$this->assertTrue($this->iso0420Instance->setField011("270003"));
		$this->assertTrue($this->iso0420Instance->setField012("123000"));
		$this->assertTrue($this->iso0420Instance->setField013("0711"));
		$this->assertTrue($this->iso0420Instance->setField022("325"));
		$this->assertTrue($this->iso0420Instance->setField041("00667788"));
		$this->assertTrue($this->iso0420Instance->setField042("000000030000003"));
		$this->assertTrue($this->iso0420Instance->setField090("000000000000000000000000009999999999999999"));
